...
import com.britebill.springcontracttestlab.sponsorsms.dto.*;
...
public class SponsorService {
    ...
    public SponsorService() {
        ...
        this.addSponsor(new SponsorCreate("Amdocs"));
        this.addSponsor(new SponsorCreate("Britebill"));
    }
    ...
    public Optional<Sponsorship> addSponsorship(String sponsorId, SponsorshipCreate sponsorshipCreate)
        ...
        PaymentRequest paymentRequest =  new PaymentRequest(sponsorshipCreate.getPaymentDetails().getHolder(),
                ...
                sponsorshipCreate.getPaymentDetails().getExpiration(), sponsorClass.get().getPrice(),
                sponsorshipCreate.getPaymentDetails().getNote());
